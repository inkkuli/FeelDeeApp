...
export default function FeeldeeInput6() {
   ...
   const savediary = async () => {
      //A NEW ITEM
      let new_data = { "id": key, "title": title, "diary": diary ,"month":month,"date":date,"uri":'https://raw.githubusercontent.com/inkkuli/FeelDeeApp/main/assets/Emo06.jpg'};
      //SAVE
      ...
      <View style={{ flex: 1, backgroundColor: '#E7FBFF', padding: 10 }}>
         ...
         <View style={{ margin: 20, padding: 10, width: 335, height: 470, borderColor: 'white', backgroundColor: 'lightyellow', borderRadius: 20 }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: 'center', marginBottom: 20, marginTop: 20 }}>
               <Image style={{ width: 100, height: 100 }} source={{ "uri": "https://raw.githubusercontent.com/inkkuli/FeelDeeApp/main/assets/Emo06.jpg" }} />
            </View>
