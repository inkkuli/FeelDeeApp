...
export default function FeeldeeInput7() {
   const [title, setTitle] = useState([]);
   const [diary, setDiary] = useState([]);
   const [today, setToday] = useState(moment());
   const [uri, setUri] = useState(['https://raw.githubusercontent.com/inkkuli/FeelDeeApp/main/assets/Emo07.jpg'])
      ...
      <View style={{ flex: 1, backgroundColor: '#E7FBFF', padding: 10 }}>
         ...
         <View style={{ margin: 20, padding: 10, width: 335, height: 470, borderColor: 'white', backgroundColor: 'lightyellow', borderRadius: 20 }}>
            ...
            <View style={{ flexDirection: "row", justifyContent: 'center', marginBottom: 20, marginTop: 20 }}>
               <Image style={{ width: 100, height: 100 }} source={{ "uri": "https://raw.githubusercontent.com/inkkuli/FeelDeeApp/main/assets/Emo07.jpg" }} />
            </View>
